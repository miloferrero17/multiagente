...
Lee ./data/embeddings/pinecone_ready.jsonl y upserta en Pinecone via REST:
POST {PINECONE_URL}/vectors/upsert

Config (env or .env):
  PINECONE_URL       e.g. https://<your-index>-xxxx.svc.<region>.pinecone.io
  PINECONE_API_KEY   your Pinecone API key
  PINECONE_NAMESPACE optional namespace
  INPUT_JSONL        optional path to JSONL (default ./data/embeddings/pinecone_ready.jsonl)
