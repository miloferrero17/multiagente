...
Lee JSONs desde INPUT_DIR (por defecto ./data/out), genera embeddings usando OpenAI
(text-embedding-3-small por defecto) y escribe cada vector como una línea en:
  ./data/embeddings/pinecone_ready.jsonl

Cada línea es un dict listo para Pinecone:
  {"id": "<id>", "values": [...], "metadata": {...}}

Config via .env:
  INPUT_DIR                default ./data/out
  OUTPUT_DIR               default ./data/embeddings
  OUTPUT_JSONL             default pinecone_ready.jsonl inside OUTPUT_DIR
  OPENAI_EMBEDDING_MODEL   default text-embedding-3-small
  EMBED_BATCH_SIZE         how many inputs per embeddings call (default 100)
  MAX_RETRIES              retries for API calls (default 3)
"""
