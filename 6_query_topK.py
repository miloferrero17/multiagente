...
def parse_args():
    ...
    p.add_argument("--team", help="Filtrar por metadata.team/Team (escritura libre). Si no se pasa, te preguntará en consola si estás en TTY.")
    return p.parse_args()
