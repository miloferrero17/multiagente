#!/usr/bin/env python3
"""
services/trello_comments.py

Usage (with venv activated and .env present):
  # use list id from .env (TRELLO_LIST_ID) or pass it as first arg
  python3 services/trello_comments.py [LIST_ID] [OUT_JSON] [DATE_FROM] [DATE_TO]

Or set in .env:
  TRELLO_KEY=
  TRELLO_TOKEN=
  TRELLO_LIST_ID=
  TRELLO_DATE_FROM=2025-12-01
  TRELLO_DATE_TO=2025-12-31

DATE formats accepted: YYYY-MM-DD or ISO-8601 (e.g. 2025-12-22 or 2025-12-22T13:32:45Z).
"""
